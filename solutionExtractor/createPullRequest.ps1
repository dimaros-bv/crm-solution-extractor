# source: https://github.com/shayki5/azure-devops-create-pr-task/blob/master/task/createPullRequest.ps1

function CreatePullRequestRoot {
  [CmdletBinding()]
  Param
  (
    [string]$repoType = 'Azure DevOps',
    [string]$sourceBranch,
    [string]$targetBranch,
    [string]$title,
    [string]$description,
    ...
    [string]$mergeStrategy = 'Merge (No fast-forward)',
    [bool]$deleteSourch = $false,
    [string]$commitMessage,
    [bool]$transitionWorkItems = $false,
    [bool]$linkWorkItems = $false,
    [string]$teamProject,
    [string]$repositoryName,
    [string]$githubRepository,
    [bool]$passPullRequestIdBackToADO = $false,
    [bool]$isForked = $false,
